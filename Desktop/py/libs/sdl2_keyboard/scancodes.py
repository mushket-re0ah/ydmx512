...
# hese values are mapped from usage page 0x0C (USB consumer page).
...
# of the display.
SDL_SCANCODE_SOFTRIGHT = 288  # Usually situated below the display on phones
# and used as a multi-function feature key for selecting
...
SDL_SCANCODE_TO_KEYCODE_MAP = {
    ...
    SDL_SCANCODE_PRINTSCREEN: 'PRTSC',
    ...
    SDL_SCANCODE_LOCKINGCAPSLOCK: 'LOCKINGCAPSLOCK',
    SDL_SCANCODE_LOCKINGNUMLOCK: 'LOCKINGNUMLOCK',
    SDL_SCANCODE_LOCKINGSCROLLLOCK: 'LOCKINGSCROLLLOCK',
    ...
    SDL_SCANCODE_KP_BACKSPACE: 'BACKSPACE',
...
def scancode_is_modifier(scancode: int) -> bool:
    return scancode in _MODIFIER_SCANCODES


_MODIFIER_KEYS = {
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_LCTRL],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_RCTRL],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_LSHIFT],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_RSHIFT],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_LALT],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_RALT],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_LGUI],
    SDL_SCANCODE_TO_KEYCODE_MAP[SDL_SCANCODE_RGUI]
}
